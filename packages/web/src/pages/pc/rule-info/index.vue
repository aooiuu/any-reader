    ...
    <div v-else class="px-10 py-10 h-full flex flex-col overflow-hidden">
      <div class="flex-1 overflow-hidden flex flex-col">
        ...
        <div class="flex-1 flex overflow-hidden">
          <KeepAlive>
            <AForm v-if="formType === 'Form'" :model="formData" :auto-label-width="true" class="flex-1 overflow-auto pr-10" layout="vertical">
            ...
            <JsonEditor v-else-if="formType === 'JSON'" :model-value="formDataText" @update:model-value="setFormData" />
            <AnalyzerRule v-else-if="formType === 'AnalyzerRule'" :rule="formData" />
            <AnalyzerText v-else-if="formType === 'AnalyzerText'" />
            <AnalyzerURL v-else-if="formType === 'AnalyzerURL'" :rule="formData" />
          </KeepAlive>
        </div>
      </div>
...
const formType = ref<FormType>('JSON');
